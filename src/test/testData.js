...
const reservations = [{
    id: '12345',
    restaurantId: '123',
    userId: 'ZMyqK1yBsxclobJ7WQtCnp64j6Y2', // replace these userIds with your own
    ...
    id: '12346',
    restaurantId: '345',
    userId: 'ZMyqK1yBsxclobJ7WQtCnp64',
...
const reviews = [{
    ...
    userId: 'ZMyqK1yBsxclobJ7WQtCnp64',
    rating: 4.0,
    // replace the "learnfirebase-2" with the app id you choose during setup. These links won't
    // point to anything until we upload these files to Cloud Storage.
    photoUrls: ['https://storage.googleapis.com/learnfirebase-2.appspot.com/reviewPhotos/hemingways-review-1.jpeg'],
    text: `
...
const restaurants = [{
    id: '123',
    name: 'Hemingway\'s',
    imageUrl: 'https://storage.googleapis.com/learnfirebase-2.appspot.com/restaurants/hemingways.jpeg',
    rating: 4.0,
    address: {
    ...
    id: '345',
    name: 'Ben\'s Burgers',
    imageUrl: 'https://storage.googleapis.com/learnfirebase-2.appspot.com/restaurants/bens-burgers.jpeg',
    rating: 3.5,
    address: {
    ...
    id: '678',
    name: 'Le Mollusc',
    imageUrl: 'https://storage.googleapis.com/learnfirebase-2.appspot.com/restaurants/le-mollusc.jpeg',
    rating: 4.5,
    address: {
